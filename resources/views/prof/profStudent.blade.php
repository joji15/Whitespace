    ...
    <div class="row">
      <div class="col-12 col-md-4 col-lg-4 mt-4">
        <div class="card border-blue-grey">
          ...
          <a href="/prof/Student/CreateClass"><div class="card-footer border-blue-grey">
      ...
      <div class="col-12 col-md-4 col-lg-4 mt-4">
        <div class="card border-blue-grey">
          ...
          <a href="/prof/Student/ViewProgress"><div class="card-footer border-blue-grey">
      ...
      <div class="col-12 col-md-4 col-lg-4 mt-4">
        <div class="card border-blue-grey">
          ...
          <a href="/prof/Student/ViewDatabase"><div class="card-footer border-blue-grey">
