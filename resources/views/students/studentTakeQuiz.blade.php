    ...
    <div class="row">
      <div class="col-12 mt-3 mb-2">
        <div class="card border-blue-silver">
          <form action="{{route('student.Profile.Quiz.SubmitAnswer')}}" method="POST">
            ...
            <div class="card-body bg-light">
              ...
              <input type="hidden" value="{{$quiz_sched_id}}" name="quizSchedID">
              @php $count = 0 @endphp
                ...
                <div class="col-12 col-lg-4 mt-4 ml-3">
                  ...
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-radio">
                      <input name="qchoices{{$q->question_id}}" type="radio" class="custom-control-input" value="choice_A">
                      <span class="custom-control-indicator"></span>
                      <div class="choice">{{$q->choice_A}}</div>
                    </label>
                    <label class="custom-control custom-radio">
                      <input name="qchoices{{$q->question_id}}" type="radio" class="custom-control-input" value="choice_B">
                      <span class="custom-control-indicator"></span>
                      <div class="choice">{{$q->choice_B}}</div>
                    </label>
                    <label class="custom-control custom-radio">
                      <input name="qchoices{{$q->question_id}}" type="radio" class="custom-control-input" value="choice_C">
                      <span class="custom-control-indicator"></span>
                      <div class="choice">{{$q->choice_C}}</div>
                    </label>
                    <label class="custom-control custom-radio">
                      <input name="qchoices{{$q->question_id}}" type="radio" class="custom-control-input" value="choice_D">
                      <span class="custom-control-indicator"></span>
            ...
            <div class="card-footer bg-lightprimary text-right">
              <button id="submitQuiz" role="button" type="submit" name="submitQuiz" class="btn btn-primary"><span class="oi oi-location"></span> Submit</button>
            </div>
          </form>
        </div>
      </div>
