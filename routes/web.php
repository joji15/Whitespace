...
Route::prefix('student')->group(function(){
    ...
    Route::prefix('SQLLesson')->group(function(){
        ...
        Route::prefix('chapter2')->group(function(){
            ...
            Route::get('using_data_types', 'studentController@using_data_types')->name('student.SQLLesson.chapter2.using_data_types');
        ...
        Route::prefix('chapter3')->group(function(){
            ...
            Route::get('simple_queries', 'studentController@simple_queries')->name('student.SQLLesson.chapter3.simple_queries');
...
Route::prefix('prof')->group(function(){
    ...
    Route::prefix('Quiz')->group(function(){
        ...
        Route::post('EditQuiz', 'quiz_controller@edit')->name('prof.quiz.EditQuiz.submit');
