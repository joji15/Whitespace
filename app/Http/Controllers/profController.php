...
class profController extends Controller
{
  ...
  */
  ...
  public function StudHistory(Request $req)
  {
    ...
    return view('prof.profHistory', compact('class_ID','history','student'));
  }
  ...
  public function addSchedule(Request $req)
  {
    ...
    $checkClass = DB::table('quiz_sched_tbl')
               ->whereRaw('quiz_id ='.  $quizID.'  AND class_id =' .$classID)
               ->get();
      ...
      $checkBetweenTime = DB::table('quiz_sched_tbl')
                          ->whereRaw('quiz_date = "'.$quiz_date.'" AND "'.$time_start.'" BETWEEN time_start time_end');
